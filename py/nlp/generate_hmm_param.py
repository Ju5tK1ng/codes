...
PINYIN2HANZI = 'pinyin2hanzi.txt'
SENTENCE_FILE = 'setence.txt'
WORD_FILE = 'word.txt'

PY2HZ_FILE = r'result\hmm_py2hz.model'
START_FILE = r'result\hmm_start.model'
EMISSION_FILE = r'result\hmm_emission.model'
TRANSITION_FILE = r'result\hmm_transition.model'
