class DefaultHmmParams():
    def __init__(self):
        self.py2hz_dict = self.load_model(r'result\hmm_py2hz.model')
        self.start_dict = self.load_model(r'result\hmm_start.model')
        self.emission_dict = self.load_model(r'result\hmm_emission.model')
        self.transition_dict = self.load_model(r'result\hmm_transition.model')
